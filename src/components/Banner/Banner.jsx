      ...
      <div className="rounded-2xl bg-white overflow-hidden shadow-xl">
        ...
        >
          <div className="w-full bg-white   p-6 md:p-10 lg:p-18 flex flex-col-reverse lg:flex-row items-center justify-between gap-8">
            ...
            <div className="space-y-5 text-center lg:text-left max-w-2xl">
              <h2 className="text-3xl md:text-5xl lg:text-[56px] leading-tight font-extrabold">
                Lightning <span className="text-[#ACC857]">Fast Delivery</span>{" "}
                & Hassle-Free Pickup
              </h2>
              ...
              <div className="flex flex-col sm:flex-row gap-3 justify-center lg:justify-start">
                ...
                <Link
                  to="/rider"
                  className="bg-white text-black/80 px-6 py-3 border border-gray-300 rounded-full font-bold hover:bg-gray-100 transition"
                >
                  Be A Rider
                </Link>
              </div>
          ...
          <div className="w-full bg-white   p-6 md:p-10 lg:p-18  flex flex-col-reverse lg:flex-row items-center justify-between gap-8">
            ...
            <div className="space-y-5 text-center lg:text-left max-w-2xl">
              <h2 className="text-3xl md:text-5xl lg:text-[56px] leading-tight font-extrabold">
                Fastest <span className="text-[#ACC857]">Delivery</span> & Easy{" "}
          ...
          <div className="w-full bg-white  p-6 md:p-10 lg:p-18  flex flex-col-reverse lg:flex-row items-center justify-between gap-8">
            ...
            <div className="space-y-5 text-center lg:text-left max-w-2xl">
              <h2 className="text-3xl md:text-5xl lg:text-[56px] leading-tight font-extrabold">
                Delivery in <span className="text-[#ACC857]">30 Minutes</span>{" "}
                at your doorstep
              </h2>
