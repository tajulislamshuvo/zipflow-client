      ...
      <aside>
        ...
        <div>
          <div className="flex md:flex-row flex-col flex-wrap justify-center gap-2 md:gap-4 lg:gap-6 items-center md:mt-4 py-7 font-medium text-[#DADADA]">
            ...
            <a href="/rider" className="hover:underline">
              Rider
            </a>
      ...
      <nav>
        <div className="grid grid-flow-col gap-4">
          <a>
            <FaLinkedinIn
              size={25}
              className="text-white bg-blue-500  rounded p-0.5 hover:scale-110 hoverEffect"
            />
          </a>
          ...
          <a>
            <BsTwitterX
              size={25}
              className="bg-white text-black rounded p-0.5 hover:scale-110 hoverEffect"
            />
          </a>
          <a>
            <FaFacebookF
              size={25}
              className="text-white p-0.5 py-1 bg-blue-500 rounded hover:scale-110 hoverEffect"
            />
          </a>
          <a>
            <IoLogoYoutube
              size={25}
              className="text-red-600 bg-white p-0.5 rounded hover:scale-110 hoverEffect"
            />
          </a>
        </div>
      </nav>
