    ...
    <div className='flex md:flex-row gap-9 flex-col-reverse justify-between items-center bg-[#03373D] sm:rounded-2xl p-6 py-11 text-center md:text-left sm:p-11 md:p-15 lg:p-20 my-17'>
      <div className="  space-y-6">
        ...
        <div className="flex flex-col md:flex-row md:gap-3 gap-5 items-center">
          <Link to="#" className='btn bg-[#CAEB66] px-6 py-3 rounded-full font-bold hover:bg-[#CAEB66]/90 hover:shadow-2xl hoverEffect shadow-none'>Become a Merchant</Link>

          <Link to="#" className='btn text-[#CAEB66] bg-transparent px-6 py-3 rounded-full font-bold hover:bg-[#CAEB66] hover:text-[#03373D] hoverEffect shadow-none'>Earn with ZipFlow Courier</Link>
        </div>
      </div>
